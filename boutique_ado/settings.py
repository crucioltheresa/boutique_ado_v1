...
SECRET_KEY = "django-insecure-no(8wj!n)6tsy1-%*c$ev+qlo!l!x=xbmn!*-qn(re(gd=a-7o"
...
ALLOWED_HOSTS = [
    "127.0.0.1",
    "localhost",
    "boutique-ado-mt-bb71af4e5c6e.herokuapp.com",
]
...
ACCOUNT_AUTHENTICATION_METHOD = "username_email"  # users log in with username or email
ACCOUNT_EMAIL_REQUIRED = True  # email is required for registration
ACCOUNT_EMAIL_VERIFICATION = "mandatory"  # require email verification for registration
ACCOUNT_SIGNUP_EMAIL_ENTER_TWICE = (
    True  # require users to enter email twice for confirmation
)
